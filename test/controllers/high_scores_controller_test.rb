...
class HighScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create high_score" do
    assert_difference('HighScore.count') do
      post high_scores_url, params: { high_score: { password: @high_score.password, username: @high_score.username } }
    end
  ...
  test "should update high_score" do
    patch high_score_url(@high_score), params: { high_score: { password: @high_score.password, username: @high_score.username } }
